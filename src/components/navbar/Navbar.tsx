      ...
      <div className="max-w-[1388px] w-full h-[50px] mx-auto flex items-center justify-between gap-[24px] text-white px-4 ">
        ...
        <ul className="hidden md:flex items-center gap-8 text-white mt-[13px]">
          ...
          <li>
            <a
              href="#"
              className="font-[Montserrat] font-normal text-[14px] leading-[164%] tracking-wider"
              style={{ width: 63, height: 26, letterSpacing: '5%' }}
            >
              Pricing
            </a>
          </li>
          ...
          <li className="relative group">
            ...
            >
              Services 
              <span className="ml-[2px] relative top-[1px] text-sm">▾</span>
            </button>
          ...
          <li>
            <a
              href="#"
              className="font-[Montserrat] font-normal text-[14px] leading-[164%] tracking-wider"
              style={{ width: 71, height: 26, letterSpacing: '5%' }}
            >
              Support
            </a>
          </li>
          ...
          <li>
            <a
              href="#"
              className="font-[Montserrat] font-normal text-[14px] leading-[164%] tracking-wider"
              style={{ width: 41, height: 26, letterSpacing: '5%' }}
            >
              Blog
            </a>
          </li>
          ...
          <li>
            <a
              href="#"
              className="font-[Montserrat] font-normal text-[14px] leading-[164%] tracking-wider whitespace-nowrap"
              style={{ width: 95, height: 26, letterSpacing: '5%' }}
            >
              Contact us
            </a>
          </li>
        ...
        <div
          className="text-[#54F4FC] font-[Montserrat] font-semibold text-[16px] leading-[164%] tracking-wider cursor-pointer whitespace-nowrap mt-[12px]"
        >
          SIGN UP
        </div>
      </div>
