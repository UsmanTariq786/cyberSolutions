  ...
  return (
    <footer className="bg-black text-white pt-12 pb-6 px-4 md:px-16">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-8 border-b border-[#222] pb-8">
        ...
        {/* Social Icons */}
        <div className="flex items-end md:items-center justify-end w-full md:w-auto mt-8 md:mt-0">
          <div className="flex gap-4">
            <a href="#" aria-label="Facebook" className="hover:text-[#54f4fc] transition-colors">
            ...
            <a href="#" aria-label="Telegram" className="hover:text-[#54f4fc] transition-colors">
            ...
            <a href="#" aria-label="Instagram" className="hover:text-[#54f4fc] transition-colors">
            ...
            <a href="#" aria-label="Other" className="hover:text-[#54f4fc] transition-colors">
